...
const ImportantList = ({isSpam,attachment,isImportant,isTrash,isRead,isStarred,mailid,profile,email,name,subject,message,time}) => {
    ...
    const openMessageFroReadMail = async()=>{
        ...
        navigate('/home/important/'+mailid)
    }
